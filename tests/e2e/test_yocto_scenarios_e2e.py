...
def test_yocto_policy_gate_fail_scenario(mock_yocto_lab, monkeypatch, capsys):
    ...
    pipeline_path = str(Path(__file__).parent.parent.parent / "pipelines" / "integration" / "yocto_policy_gate_fail.yaml")
...
def test_yocto_full_cycle_success_scenario(mock_yocto_lab, monkeypatch, capsys):
    pipeline_path = str(Path(__file__).parent.parent.parent / "pipelines" / "integration" / "yocto_full_cycle_success.yaml")
